  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const response = await httpCommon.get(
        `/get_site_master_table_data.php?site_cd=${site_ID}&page=${currentPage}`
      );
...
// }, [site_ID, currentPage, selectDropRowID]);
  ...
  const handleEditRow = useCallback(
    (id,row) => {
      ...
      if (Rowid !== '' && AstNo !== '') {
        navigate(`/dashboard/system-admin/site/form`, {
          state: {
            RowID:Rowid,
            Ast_no:AstNo,
            currentPage,
...
const TABLE_HEAD = [
  ...
  {
    id: "siteCode",
    label: CustomizeLable("Site Code") || "Site Code:",
    width: 140,
  },
  {
    id: "siteDescription",
    label: CustomizeLable("Site Description") || "Site Description:",
    width: 80,
    padding: 10,
  },
  ...
  {
    id: "Disable",
    label: CustomizeLable("Disable") || "Disable",
    width: 80,
    padding: 10,
  },
          ...
          <CustomBreadcrumbs
            ...
            action={
              <Button
                ...
                to={{
                  pathname: "/dashboard/system-admin/site/form"
                }}
              >
