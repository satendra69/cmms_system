    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
       ...
       onClickChange(event);
          ...
          navigate(`/dashboard/system-admin/site`, {
            state: {
              currentPage,
              selectedOption,
              comeBack:"Come_Back_cancel",
                      ...
                      <Grid container spacing={2} >
                        <Grid xs={12} md={12}>
                           {/* Asset Master */}
                                                    ...
                                                    <Grid item xs={12} md={6}>
                                                      ...
                                                      >
                                                        ...
                                                        <Stack flexGrow={1} spacing={1} sx={{ pb: 1.5 }}>
                                                          ...
                                                          // className="Requiredlabel"
                                                          >
                                                            {findCustomizeLabel("telephone_no") ||
                                                              "Telephone No:"}
                                                          </Typography>
                                                      ...
                                                      >
                                                        ...
                                                        <Stack flexGrow={1} spacing={1} sx={{ pb: 1.5 }}>
                                                          ...
                                                          // className="Requiredlabel"
                                                          >
                                                            {findCustomizeLabel("disable_flag") ||
                                                              "Disable Flag:"}
                                                                  <Checkbox  name="disable_flag" value={parseInt(data.disable_flag)} />
                                                          </Typography>
                                                      ...
                                                      >
                                                        ...
                                                        <Stack flexGrow={1} spacing={1} sx={{ pb: 1.5 }}>
                                                          ...
                                                          // className="Requiredlabel"
                                                          >
                                                            {findCustomizeLabel("require_offline") ||
                                                              "Require Offline:"}
                                                                  <Checkbox name="require_offline" />
                                                          </Typography>
                            ...
                            <Typography variant="subtitle2" className={findCustomizerequiredLabel("Address 2")}>
                              {findCustomizeLabelDet("site_type") ||
                                "Site Type"}
                            </Typography>
