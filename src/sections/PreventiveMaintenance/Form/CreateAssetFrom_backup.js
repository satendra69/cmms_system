...
import AssetParentIdList from "../MTRParentIdList"
 ...
 const [isAssetAssetEmpty, setIsAssetEmpty] = useState(false);
  ...
  const get_assetmaster_selected = async () => {
    ...
    try {
      ...
      setExpectedLifeYear(formatNumber(response.data.data["0"].ast_det_depr_term));
