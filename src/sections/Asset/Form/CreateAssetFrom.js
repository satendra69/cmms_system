...
export default function CreateAssetFrom({ currentUser, onPageChange }) {
  ...
  const { RowID, Ast_no, DuplicatRowid, DupRowID, DupAst_no, currentPage, selectedOption, selectDropRowID ,TabBtnName} = state || {};
  ...
  const [DepreciationMethod, setDepreciationMethod] = useState([{ label: "SL : Straight-Line", value: "SL" }, { label: "DB : Declining-Balance", value: "DB" }, { label: "DD : Double-Declining", value: "DD" }]);
 ...
 const [isAssetAssetEmpty, setIsAssetEmpty] = useState(false);
  ...
  const [MRHistoryShow, setMRHistoryhandleShow] = useState(false);
  const MRHistoryhandleClose = () => setMRHistoryhandleShow(false);
  const MRHistoryhandleShow = () => setMRHistoryhandleShow(true);
  ...
  const [AssetSubModuleBtn, setAssetSubModuleBtn] = useState("");
  ...
  useEffect(() => {
    if (TabBtnName) {
      ...
      if (TabBtnName === 'BtnSpares') {
        setTabValue(2); 
        setLoadSpares(true);
      }else if (TabBtnName === 'BtnUsage') {
        setTabValue(3); 
        setLoadUsage(true);
      } else if (TabBtnName === 'BtnSpecification') {
        setTabValue(4); 
...
const handleAssetSpecifi = (btnClkDataRecived) =>{
  setAssetSubModuleBtn(btnClkDataRecived);
}
...
// console.log("AssetMandatoryFiled_____",AssetMandatoryFiled);
    ...
    //  console.log("json_Asset Data_responce__", response);
      ...
      if (response.data.status === "SUCCESS") {
       ...
       let GetAssetNo = response.data.Asset_No;
...
if (
  ...
  DepreciationMethod = DepreciationS.length > 0 ? DepreciationS[0].trim() : "";
}
                                                        ...
                                                        <Tooltip
                                                          ...
                                                          >
                                                            ...
                                                            <Iconify
                                                              ...
                                                              <MenuItem onClick={MRHistoryhandleShow}>
                                                                <Iconify
                                                          ...
                                                          <Stack flexGrow={1} spacing={1} sx={{ pb: 1.5 }}>
                                                            ...
                                                            <Autocomplete
                                                              ...
                                                              onChange={(event, value) => {
                                                                ...
                                                                if (value === null) {
                                                                  // Clear the selected status when the clear icon is clicked
                        ...
                        >
                            ...
                            <Autocomplete
                              ...
                              renderInput={(params) => (
                                <TextField
                                  ...
                                  // }`}
                                  className={errorField === "ast_mst_wrk_grp" ? "erroBorderadd" : "Extrasize"}
                                  ref={autocompleteRef}
                                />
                              )}
                            />
                          ...
                          <Stack direction="row" alignItems="center" spacing={1}>
                              <Checkbox
                               ...
                               onChange={(e) => {
                                setPermanent_ID(Permanent_ID == 1 ? 0 : 1);
                                setPermanentIDFlag(""); // Add this line to reset Permanent_IDFlag
                              }}
                                color="primary"
                              />
                              {Permanent_ID != 1 && (
                                <div ref={assetNoAutocompleteRef} style={{ flexGrow: 1 }} className="hoverContainerIconBtn">
                                  <CustomTextField
                                    id="outlined-basic"
                                    variant="outlined"
                                    size="small"
                      ...
                      <Grid container spacing={2}>
                          ...
                          <Stack spacing={1}>
                            ...
                            <Stack spacing={1}>
                                  ...
                                  <Typography variant="subtitle2" className={findCustomizerequiredLabel("ast_det_note1")}>
                          ...
                          <Grid container spacing={2}>
                                ...
                                <Stack flexGrow={1} spacing={1}>
                                  ...
                                  renderInput={(params) => (
                                    <TextField
                                      ...
                                      placeholder="Select..."
                                      variant="outlined"
                                      className={errorField === "ast_det_depr_method" ? "erroBorderadd" : "Extrasize"}
                                      fullWidth // Make it full-width
                                    />
                                  )}
                                />
                            ...
                            <Grid item xs={12} md={6}>
                              ...
                              <Stack spacing={1} sx={{ pb: 1.8 }}>
                                ...
                                <div ref={CustomerCodeRef} style={{ flexGrow: 1 }} className="hoverContainerIconBtn">
                                  <CustomTextField
                                    id="outlined-basic"
                                    variant="outlined"
                                    size="small"
                                ...
                                <Autocomplete
                                  ...
                                  renderInput={(params) => (
                                    <TextField
                                      ...
                                      variant="outlined"
                                      fullWidth // Make it full-width
                                      className={errorField === "ast_det_l_account" ? "erroBorderadd" : "Extrasize"}
                                    />
                                  )}
                                />
                              </Stack>
                                ...
                                <Autocomplete
                                  ...
                                  renderInput={(params) => (
                                    <TextField
                                      ...
                                      variant="outlined"
                                      fullWidth // Make it full-width
                                      className={errorField === "ast_det_m_account" ? "erroBorderadd" : "Extrasize"}
                                    />
                                  )}
                                />
                              </Stack>
                            ...
                            <Autocomplete
                              ...
                              renderInput={(params) => (
                                <TextField
                                  ...
                                  variant="outlined"
                                  fullWidth // Make it full-width
                                  className={errorField === "ast_det_c_account" ? "erroBorderadd" : "Extrasize"}
                                />
                              )}
                            />
                          </Stack>
