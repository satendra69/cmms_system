    ...
    <div className="kpi_management">
        ...
        <div className="kpi_report" style={{ marginTop: "10px" }}>
          <Card style={{  height: "420px",padding:"0 20px" }}>
            ...
            >
              <div style={{width:"10%",marginLeft:"-30px"}} className="m45">
              <h2 className="vertical_text op" >Total Work Order</h2>
              </div>
              <div
            ...
            <div style={{ width: "10%", marginLeft: "-50px",marginTop:"-50px" }} className="mltotal mtegmob2">
