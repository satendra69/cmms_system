...
function FaultCode({ seriesData, seriesDataLoc }) {
  ...
  useEffect(() => {
    const fetchKpi = async () => {
      ...
      const response = await httpCommon.get(
        `/get_kpi_fault_code.php?site_cd=${site_ID}&year=${year}&location=${loc}`
      );
  ...
  useEffect(() => {
    const fetchKpi = async () => {
      ...
      const response = await httpCommon.get(
        `/get_kpi_fault_code_pie.php?site_cd=${site_ID}&sortBy=${
          sort ? sort : "Yearly"
        }&year=${year}`
      );
  ...
  return (
    <div className="kpi_management">
      ...
      >
        ...
        <div
          className="kpi_report"
          style={{ marginTop: "18px", height: "300px", padding: "0 10px" }}
        >
          {/* <Card style={{ height: "320px", padding: "0 10px" }}> */}
          <div className="title">
            <div>
            <h3 style={{ fontStyle: "bold", marginBottom: "4px",fontSize:"13px" }}>
             Top 10 Fault Code by Corrective Work Order
                </h3>
                <Divider
          ...
          >
            <div style={{ width: "10%", marginLeft: "-40px" }}>
              <h2 className="vertical_text" style={{ marginTop: "30px",fontSize:"10px" }}>
                Total Work Order 
              </h2>
            </div>
            ...
            <div
              className="chart"
              style={{ width: "100%", marginLeft: "-50px",marginTop:"-40px" }}
            >
