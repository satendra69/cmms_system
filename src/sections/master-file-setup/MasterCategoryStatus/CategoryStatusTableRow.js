...
export default function CategoryStatusTableRow({
  row,
  selected,
  onSelectRow,
  onDeleteRow,
  ...
  const { sts_cat_cat_cd, sts_cat_desc } = row;
  ...
  return (
    <>
      ...
      <TableRow hover selected={selected} sx={{ paddingLeft: "20px" }}>
        ...
        <TableCell sx={{ height: "40px" }}>{sts_cat_cat_cd}</TableCell>
        <TableCell>{sts_cat_desc}</TableCell>
      </TableRow>
...
CategoryStatusTableRow.propTypes = {
