...
export default function MasterAssetLevelRow({
  ...
  const { ast_lvl_ast_lvl, ast_lvl_desc, ast_lvl_disable_flag } = row;
  ...
  return (
    <>
      ...
      <TableRow hover selected={selected}>
        ...
        <TableCell sx={{ height: "40px" }}>{ast_lvl_ast_lvl}</TableCell>
        <TableCell sx={{ marginLeft: "-10px" }}>{ast_lvl_desc}</TableCell>
        <TableCell>
          <div>
            <Checkbox
              checked={Number(ast_lvl_disable_flag)}
              disabled
              // style={{
              //   color: "green",
              // }}
