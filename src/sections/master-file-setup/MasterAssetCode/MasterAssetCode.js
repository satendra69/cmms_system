...
const TABLE_HEAD = [
  ...
  { id: "ast_cod_ast_cd", label: "Asset Code", width: 130 },
  { id: "ast_cod_desc", label: "Description", width: 200 },
  { id: "ast_cod_disable_flag", label: "Disable", width: 600 },
];
...
export default function MasterAssetCode() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const response = await httpCommon.get(
        "/get_master_asset_code.php?site_cd=" + site_ID
      );
