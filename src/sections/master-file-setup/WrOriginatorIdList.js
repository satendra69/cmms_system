...
const WrOriginatorIdList = ({ onRowClick, onChangePage, onSearchChange }) => {
  ...
  useEffect(() => {
    httpCommon
      .get("/WrOriginatorId.php?site_cd=" + site_ID)
      .then((response) => {
  ...
  const handleSearch = (searchText) => {
    ...
    const filteredData = data.filter(
      (item) =>
        item.emp_mst_empl_id.toLowerCase().includes(searchText.toLowerCase()) ||
...
export default WrOriginatorIdList;
