...
import MasterAssetWrkDialog from "./MasterAssetWrkDialog";
...
export default function MasterAssetWrkRow({
  row,
  selected,
  onSelectRow,
  onDeleteRow,
  ...
  const { mst_war_work_area, mst_war_desc, mst_war_disable_flag } = row;
  ...
  return (
    <>
      ...
      <TableRow hover selected={selected}>
        ...
        <TableCell sx={{ height: "40px" }}>{mst_war_work_area}</TableCell>
        <TableCell sx={{ marginLeft: "-10px" }}>{mst_war_desc}</TableCell>
        <TableCell>
          <div>
            <Checkbox
              checked={Number(mst_war_disable_flag)}
              disabled
              // style={{
              //   color: "green",
              // }}
