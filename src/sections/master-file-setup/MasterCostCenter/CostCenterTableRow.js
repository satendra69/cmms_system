...
import UserGroupDialog from "./CostCenterDialog";
import UserGroupADDDialog from "./CostCenterADDDialog";
...
export default function CostCenterTableRow({
  row,
  selected,
  onSelectRow,
  onDeleteRow,
  ...
  const { costcenter, descs, disable_flag } = row;
  ...
  return (
    <>
      ...
      <TableRow hover selected={selected}>
        ...
        <TableCell sx={{ height: "40px" }}>{costcenter}</TableCell>
