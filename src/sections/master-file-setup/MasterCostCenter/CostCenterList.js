...
import CostCenterHeadCustom from "./CostCenterHeadCustom";
import CostCenterTableRow from "./CostCenterTableRow";
import CostCenterADDDialog from "./CostCenterADDDialog";
...
const TABLE_HEAD = [
  ...
  { id: "costcenter", label: "Cost Center", width: 100 },
  { id: "descs", label: "Description", width: 200 },
...
export default function CostCenterList() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      setTableData(response.data.data.Cost_Center);
      setDataFiltered(response.data.data.Cost_Center);
      const dataLength = response.data.data.Cost_Center;
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="description" content="Cost Center" />
      </Helmet>
