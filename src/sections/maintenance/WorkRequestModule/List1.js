...
const List1 = ({ onRowClick, data,ApprovalStatus }) => {
  ...
  useEffect(() => {
    ...
    if(FormStatus !== "" && FormStatus == "NEW" ){
      get_WR_List1_Header(site_ID);
    }else{
      get_WR_List1(site_ID, RowID);
    }
  ...
  // First Api
  const get_WR_List1 = async (site_ID, RowID) => {
    Swal.fire({
      title: "Please Wait!",
    ...
    try {
      const response = await httpCommon.get(
        `/get_WR_List1.php?site_cd=${site_ID}&RowID=${RowID || ""}`
      );
  ...
  const get_WR_List1_Header = async (site_ID) => {
    Swal.fire({
      title: "Please Wait!",
      allowOutsideClick: false,
      customClass: {
  ...
  const renderTableRows = () => {
    ...
    return Result.map((result, index) => (
      ...
      <TableCell style={{ padding: "5px", textAlign: "center" }}>
        ...
        <TableCell style={{ padding: "5px", textAlign: "center" }}>
          {result.wkr_ls1_varchar1}
        </TableCell>
        <TableCell style={{ padding: "5px", textAlign: "center" }}>
          {result.wkr_ls1_varchar2}
        </TableCell>
        <TableCell style={{ padding: "5px", textAlign: "center" }}>
          {result.wkr_ls1_varchar3}
        </TableCell>
        {result.wkr_ls1_datetime1 &&
        result.wkr_ls1_datetime1.date ? (
          <TableCell style={{ padding: "5px", textAlign: "center" }}>
            {formatDateTime(result.wkr_ls1_datetime1.date)}
          </TableCell>
        ) : (
          <TableCell style={{ padding: "5px", textAlign: "center" }}>
            {/* Render empty value */}
         ...
         {result.wkr_ls1_datetime2 &&
        result.wkr_ls1_datetime2.date ? (
          <TableCell style={{ padding: "5px", textAlign: "center" }}>
            {formatDateTime(result.wkr_ls1_datetime2.date)}
          </TableCell>
        ) : (
          <TableCell style={{ padding: "5px", textAlign: "center" }}>
            {/* Render empty value */}
        ...
        {result.wkr_ls1_datetime3 &&
        result.wkr_ls1_datetime3.date ? (
          <TableCell style={{ padding: "5px", textAlign: "center" }}>
            {formatDateTime(result.wkr_ls1_datetime3.date)}
          </TableCell>
        ) : (
          <TableCell style={{ padding: "5px", textAlign: "center" }}>
            {/* Render empty value */}
        ...
        <TableCell style={{ padding: "5px", textAlign: "center" }}>
          {formatNumber(result.wkr_ls1_numeric1)}
        </TableCell>
        <TableCell style={{ padding: "5px", textAlign: "center" }}>
          {formatNumber(result.wkr_ls1_numeric2)}
        </TableCell>
...
const getWRList1FromLebel = async () => {
  try {
    ...
    if (response.data.status === "SUCCESS") {
      setWRLabel(response.data.data.wkr_ls1);
    }
  } catch (error) {
    console.error("Error fetching data:", error);
  }
...
const handleEdit = (data) => {
  ...
  setEditVar1(data.wkr_ls1_varchar1);
  setEditVar2(data.wkr_ls1_varchar2);
  setEditVar3(data.wkr_ls1_varchar3);
  setEditNumeric1(formatNumber(data.wkr_ls1_numeric1));
  setEditNumeric2(formatNumber(data.wkr_ls1_numeric2));
  setEditDateTime1(data.wkr_ls1_datetime1);
  setEditDateTime2(data.wkr_ls1_datetime2);
  setEditDateTime3(data.wkr_ls1_datetime3);
    ...
    if (allEmpty) {
      ...
      try {
        const response = await httpCommon.post(
          "/insert_work_request_list_1_data.php",
          inputFields
        );
  ...
  const handleShow = () => {
    ...
    if(FormStatus !== "" && FormStatus == "NEW" ){
      Swal.fire({
        ...
        title: "Please Wait!",
        allowOutsideClick: false,
        text: "Once the Work Request is created, you can then add detailed list 1 .",
        width:"400px"
      });
      onRowClick("BtnList1");
    }else{
                        ...
                        <div className="row my-3 tb" key={index}>
                          ...
                          >
                              ...
                              <Grid
                                ...
                                style={{ padding: "10px" }}
                              >
                                <label className={findCustomizerequiredLabel("wkr_ls1_varchar1")}>{findCustomizeLabel("wkr_ls1_varchar1") ||
                                    "Varchar1:"}</label>
                              </Grid>
                              ...
                              <Grid
                                ...
                                style={{ padding: "10px" }}
                              >
                                <label className={findCustomizerequiredLabel("wkr_ls1_varchar2")}>{findCustomizeLabel("wkr_ls1_varchar2") ||
                                    "Varchar2:"}</label>
                              </Grid>
                              <Grid item xs={12} md={8}>
                                <TextField
                              ...
                              <Grid
                                ...
                                style={{ padding: "10px" }}
                              >
                                <label className={findCustomizerequiredLabel("wkr_ls1_varchar3")}>{findCustomizeLabel("wkr_ls1_varchar3") ||
                                    "Varchar3:"}</label>
                              </Grid>
                              <Grid item xs={12} md={8}>
                                <TextField
                              ...
                              <Grid
                                ...
                                style={{ padding: "10px" }}
                              >
                                <label className={findCustomizerequiredLabel("wkr_ls1_datetime1")}>{findCustomizeLabel("wkr_ls1_datetime1") ||
                                    "Datetime1:"}</label>
                              </Grid>
                              <Grid item xs={12} md={8}>
                              ...
                              <Grid
                                ...
                                style={{ padding: "10px" }}
                              >
                                <label className={findCustomizerequiredLabel("wkr_ls1_datetime2")}>{findCustomizeLabel("wkr_ls1_datetime2") ||
                                    "Datetime2:"}</label>
                              </Grid>
                              <Grid item xs={12} md={8}>
                              <DatePicker
                              ...
                              <Grid
                                ...
                                style={{ padding: "10px" }}
                              >
                                <label className={findCustomizerequiredLabel("wkr_ls1_datetime3")}>{findCustomizeLabel("wkr_ls1_datetime3") ||
                                    "Datetime3:"}</label>
                              </Grid>
                              <Grid item xs={12} md={8}>
                                <DatePicker
                              ...
                              <Grid
                                ...
                                style={{ padding: "10px" }}
                              >
                                <label className={findCustomizerequiredLabel("wkr_ls1_numeric1")}>{findCustomizeLabel("wkr_ls1_numeric1") ||
                                    "Numeric1:"}</label>
                              </Grid>
                              ...
                              <Grid
                                ...
                                style={{ padding: "10px" }}
                              >
                                <label className={findCustomizerequiredLabel("wkr_ls1_numeric2")}>{findCustomizeLabel("wkr_ls1_numeric2") ||
                                    "Numeric2:"}</label>
                              </Grid>
