    ...
    let decimalPart = parts[1];
      if ( decimalPart === '') { 
        ...
        if (integerPart2.length > 15) {
          integerPart2 = integerPart2.slice(0, 16) + '.' + integerPart2.slice(16, 18);
        }
      ...
      setData((pre) => ({
        ...
        emp_ls2_pr_approval_limit:
          filterResult && filterResult.emp_ls2_pr_approval_limit
            ? formatNumber(filterResult.emp_ls2_pr_approval_limit)
            : "",
      ...
      setData((pre) => ({
        ...
        emp_ls2_pr_approval_limit:
          rowData && rowData.emp_ls2_pr_approval_limit
            ? formatNumber(rowData.emp_ls2_pr_approval_limit)
            : "",
      }));
