...
import MaintenceSectionDialog from "./MrApproverDialog";
import MaintenceSectionDialogUpdate from "./MrApproverDialogUpdate";
    ...
    return MaintenceResult.map((item) => (
      ...
      <>
        ...
        <TableRow>
          ...
          <TableCell>{item.emp_ls3_costcenter}</TableCell>
          <TableCell>{formatNumber(item.emp_ls3_approval_limit)}</TableCell>
