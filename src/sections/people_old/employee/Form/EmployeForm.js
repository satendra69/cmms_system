...
export default function EmployeForm({ currentUser }) {
  ...
  const { call, setCall,setFullList } = useContext(PeopleContext);
  ...
  const { selectedOption,savedQuery } = state || {};
...
const fetchLogin =async()=>{
  try {
    const response = await httpCommon.get("/get_emp_login_id.php?site_cd=" + site_ID)
  ...
  useEffect(() => {
    ...
    if (RowID && state && state.row) {
      ...
      setTextFields((pre) => ({
        ...
        emp_mst_payrate: rowData.emp_mst_payrate ? rowData.emp_mst_payrate : "",
        ...
        emp_det_department: rowData.emp_det_department
          ...
          : "",
          emp_mst_pay_period:rowData.emp_mst_pay_period
      ...
      // login Id
      setSelectedLoginId(rowData.emp_mst_login_id + " : " + rowData.name )
...
if (e.target.name === "emp_det_wo_approval_limit") {
    ...
    if (error) {
      ...
      var json = {
        ...
        emp_mst_usr_grp: selectedUserGrp
          ...
          : "",
          emp_mst_login_id:selectedLoginId?selectedLoginId.replace(/ .*/, ""):"",
            ...
            <Grid xs={12} md={12}>
              ...
              >
                ...
                <Tab
                  ...
                  disabled={!checkboxData.emp_det_mr_approver || checkboxData.emp_det_mr_approver ==0  ?true:false}
                />
                ...
                <Tab
                  ...
                  disabled={!checkboxData.emp_det_pr_approver || checkboxData.emp_det_pr_approver == 0 ?true:false}
                />
                          ...
                          >
                            ...
                            <Grid item xs={12} md={6}>
                              ...
                              <Stack spacing={1} sx={{ pb: 1.5 }}>
                                ...
                                <AntDatePicker
                                value={date && date.emp_mst_date_of_birth ? dayjs(date.emp_mst_date_of_birth) : null}   
                          ...
                          />
                              ...
                              <Stack spacing={1} sx={{ pb: 1.5 }}>
                                ...
                                <AntDatePicker 
                                 ...
                                 value={date && date.emp_mst_dateofhire ? dayjs(date.emp_mst_dateofhire) : null}  
                          format="DD/MM/YYYY" 
                          className={`Extrasize ${
  ...
  <StockLocation RowID={RowID} stockLocationData={stockLocationData} setStockLocationData={setStockLocationData} handleStock={handleStock}  />
    </Box>
